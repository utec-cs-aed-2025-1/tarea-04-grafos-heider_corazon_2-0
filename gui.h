...
class GUI {
    ...
    // 1NN (1 Nearest Neighbour): Busca el nodo más cercano a una posición dada.
    // OPTIMIZACIÓN: Se implementó un Grid Espacial (Spatial Hashing) para reducir la complejidad de búsqueda
    // de O(N) (lineal) a O(1) (constante promedio), evitando iterar sobre todos los nodos del mapa.
